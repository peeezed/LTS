        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var rows = page.Select(s =>
        {
            ...
            return new ShipmentRow
            {
                ...
                KPICustomsClearanceDate = d?.KPICustomsClearanceDate,
                KPIDepartureDate = d?.KPIDepartureDate,
                KPIArrivalToDestinationDate = d?.KPIArrivalToDestinationDate,
                KPIArrivalCustomsEndDate = d?.KPIArrivalCustomsEndDate,
                KPILeadTimeToXdock = d?.KPILeadTimeToXdock,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var rows = page.Select(x =>
        {
            ...
            return new TransferRow
            {
                ...
                ShipmentCrossdockArrivalDate = shipmentDates.GetValueOrDefault(x.Shipment.ReferenceNo)?.CrossdockArrivalDate,
                KPICrossdockDepartureDate = d?.KPICrossdockDepartureDate,
